...
fun ForgotPasswordScreen(
    ...
    val firstSpacerHeight by animateDpAsState(targetValue = if (isImeVisible) 20.dp else 64.dp, animationSpec = tween(durationMillis = 300),
    ...
    Scaffold(
        ...
        Column(
            ...
            Crossfade(targetState = isImeVisible, label = "Welcome Screen Label Animation") { isKeyboardVisible ->
                Column(modifier.align(Alignment.CenterHorizontally).padding(32.dp)) {
